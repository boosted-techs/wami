        ...
        <div class="row">
            <div class="col-xl-5 col-md-6">
                <div class="top__bar-left">
                    <a href="/#"><i class="far fa-map-marker-alt"></i>Gayaza Jr Rd, Gayaza</a>
                </div>
            </div>
...
{*                    </div>*}
                    ...
                    <div class="header__area-menubar-right-sidebar-popup">
                        ...
                        <p>
                           We are premier consulting firm based in Uganda that specializes in providing expert guidance and support for businesses in terms of product development, product certification, and overall quality and safety management. We also offer specialized food safety consulting and export promotion services to help businesses expand their reach and succeed in the global marketplace.
                        </p>
                        <div class="header__area-menubar-right-box-sidebar-popup-contact">
                            ...
                            <div class="header__area-menubar-right-box-sidebar-popup-contact-item">
                                ...
                                <div class="header__area-menubar-right-box-sidebar-popup-contact-item-content">
                                    <span>Call Now</span>
                                    <h6><a href="tel:+256741965010">+256 (741) 965 010</a></h6>
                                </div>
                            </div>
                            <div class="header__area-menubar-right-box-sidebar-popup-contact-item">
                                <div class="header__area-menubar-right-box-sidebar-popup-contact-item-icon">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-5 col-lg-4">
                <div class="footer__top-btn t-right lg-t-center">
                    <a class="btn-two" href="/quote">let's Work together<i class="far fa-chevron-double-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
{*                        </div>*}
    ...
    <div class="copyright__one">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <p>Copyright 2023  <a href="/">WAMI QUALITY CONSULTS</a> - All Rights Reserved By <a href="https://boostedtechs.com">WAMI QUALITY CONSULTS</a></p>
                </div>
            </div>
        </div>
    </div>
